...
GEN = ["gen.py"]
CONF = [
    (0, 3, GEN[0], VAL[0], 10, 20),
    (0, 10, GEN[0], VAL[0], 1000, 1_000_000_000),
    (0, 5, GEN[0], VAL[0], 1000, 1_000),
    (0, 10, GEN[0], VAL[0], 100_000, 1_000_000_000),
    (0, 2, GEN[0], VAL[0], 100_000, 100_000),
    (0, 5, GEN[0], VAL[0], 100_000, 1_000),
    (0, 5, GEN[0], VAL[0], 100_000, 128),
    (0, 5, GEN[0], VAL[0], 100_000, 1_000_000),
]
SUBTASKS = [40, 60]
...
def run(name: str, argv: tuple = None, inp: str = None, out: str = None) -> bool:
    ...
    if out:
        ...
        out = ""
    print(" ".join([runner, argv, inp, out]))
